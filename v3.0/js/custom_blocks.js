...
Blockly.Blocks['image_set'] = {
  init: function init() {
    ...
    var options = [['none', 'images/crumbs.jpg'], [{ 'src': 'images/choc-chip.png', 'width': 25, 'height': 25, 'alt': 'Choc Chip Cookie' }, 'images/choc-chip.png'], [{ 'src': 'images/christmas.png', 'width': 25, 'height': 25, 'alt': 'Christmas Cookie' }, 'images/christmas.png'], [{ 'src': 'images/fortune.png', 'width': 25, 'height': 25, 'alt': 'Fortune Cookie' }, 'images/fortune.png']];
...
Blockly.Blocks['heading_set'] = {
  init: function init() {
    ...
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.appendValueInput('VALUE').setCheck('String').appendField('Set heading to');
  }
};
...
Blockly.Blocks['variables_add'] = {
  init: function init() {
    ...
    this.appendDummyInput().appendField('Add').appendField(new Blockly.FieldNumber('1'), 'NUMBER').appendField("to").appendField(new Blockly.FieldVariable('cookies'), 'VARIABLE');
  }
};
